...
export const translations = {
  en: {
    ...
    weeklyPage: {
      ...
      noConstraints: 'No constraints specified',
      equipment: 'Equipment',
      equipmentPlaceholder: 'Enter equipment separated by commas',
      noEquipment: 'No equipment specified',
      frequency: 'Frequency',
      duration: 'Duration',
        language: 'Language',
        male: 'Male',
    ...
    workoutForm: {
      ...
      saveSuccess: 'Workout saved successfully',
    ...
    workoutDetailsPage: {
      ...
      allEstimatesReady: 'All exercises already have estimates',
      estimatesUpdated: 'AI estimates updated successfully',
      estimatesUpdateFailed: 'Failed to update AI estimates',
      totalCalories: 'Total Calories',
    ...
    googleSync: {
      ...
      oauthConfig: {
        ...
        description: 'Enter an OAuth 2.0 Web Client ID. This public identifier is stored only in this browser and can be changed without rebuilding the app.',
        clientIdLabel: 'Google OAuth Client ID',
        clientIdPlaceholder: '123456789-example.apps.googleusercontent.com',
        save: 'Save Client ID',
        saving: 'Saving...',
        reset: 'Use deployment default',
        remove: 'Remove local Client ID',
        sourceLocal: 'Using the Client ID saved in this browser',
        sourceEnvironment: 'Using the Client ID from the deployment environment',
        sourceNone: 'No valid Client ID is configured',
        currentOrigin: 'Authorized JavaScript origin to add',
        setupHelp: 'In Google Cloud, enable the Drive API, create an OAuth 2.0 Client ID for a Web application, and add this origin to Authorized JavaScript origins.',
        openConsole: 'Open Google Cloud credentials',
        invalidClientId: 'Enter a valid Google OAuth Client ID ending in .apps.googleusercontent.com.',
        saved: 'Google OAuth Client ID saved',
        resetSuccess: 'The local Client ID was removed and the deployment default was restored',
        removed: 'The local Google OAuth Client ID was removed',
        saveFailed: 'Could not save the Google OAuth configuration',
        confirmChange: 'Changing the Client ID will end the current Google Drive session. Continue?'
      },
      features: {
      ...
      error: {
        ...
        notConfigured: 'Enter a valid Google OAuth Client ID above and add this site to the client’s authorized JavaScript origins.',
        invalidClientId: 'The Google OAuth Client ID is invalid.',
  ...
  ru: {
    ...
    plan: {
      ...
      generateSuccess: 'План успешно сгенерирован',
      generateModal: {
    ...
    weeklyPage: {
      ...
      profile: {
        ...
        goal: 'Цель',
        constraints: 'Ограничения',
        constraintsPlaceholder: 'Введите ограничения через запятую',
        noConstraints: 'Ограничения не указаны',
        equipment: 'Оборудование',
        equipmentPlaceholder: 'Введите оборудование через запятую',
    ...
    workoutForm: {
      ...
      saveSuccess: 'Тренировка успешно сохранена',
      updateSuccess: 'Тренировка успешно обновлена',
      deleteSuccess: 'Тренировка успешно удалена'
    },
    ...
    workoutDetailsPage: {
      ...
      deletedSuccessfully: 'Тренировка успешно удалена',
      allEstimatesReady: 'Все упражнения уже имеют оценки',
      estimatesUpdated: 'ИИ оценки успешно обновлены',
      estimatesUpdateFailed: 'Не удалось обновить ИИ оценки',
      totalCalories: 'Всего калорий',
    ...
    googleSync: {
      ...
      oauthConfig: {
        ...
        description: 'Укажите OAuth 2.0 Client ID типа «Веб-приложение». Этот публичный идентификатор хранится только в данном браузере и применяется без пересборки приложения.',
        clientIdLabel: 'Google OAuth Client ID',
        clientIdPlaceholder: '123456789-example.apps.googleusercontent.com',
        save: 'Сохранить Client ID',
        saving: 'Сохраняю...',
        reset: 'Использовать значение деплоя',
        remove: 'Удалить локальный Client ID',
        sourceLocal: 'Используется Client ID, сохранённый в этом браузере',
        sourceEnvironment: 'Используется Client ID из окружения деплоя',
        sourceNone: 'Корректный Client ID не настроен',
        currentOrigin: 'Authorized JavaScript origin, который нужно добавить',
        setupHelp: 'В Google Cloud включите Drive API, создайте OAuth 2.0 Client ID для веб-приложения и добавьте этот origin в Authorized JavaScript origins.',
        openConsole: 'Открыть Google Cloud Credentials',
        invalidClientId: 'Укажите корректный Google OAuth Client ID, оканчивающийся на .apps.googleusercontent.com.',
        saved: 'Google OAuth Client ID сохранён',
        resetSuccess: 'Локальный Client ID удалён, восстановлено значение деплоя',
        removed: 'Локальный Google OAuth Client ID удалён',
        saveFailed: 'Не удалось сохранить настройку Google OAuth',
        confirmChange: 'Смена Client ID завершит текущую сессию Google Drive. Продолжить?'
      },
      features: {
      ...
      error: {
        ...
        notConfigured: 'Укажите корректный Google OAuth Client ID выше и добавьте этот сайт в Authorized JavaScript origins OAuth-клиента.',
        invalidClientId: 'Некорректный Google OAuth Client ID.',
